                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $mahasiswa->jk }}</div>
                                <hr>
                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Jurusan</div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $mahasiswa->id_jurusan }}</div>
                                <hr>
                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Angkatan</div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $mahasiswa->id_angkatan }}</div>
                                <hr>
                            </div>
                        </div>
                    </div>
